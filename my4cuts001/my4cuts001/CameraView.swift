...
struct SettingsView: View {
    @Environment(\.dismiss) var dismiss
    @State private var countdownOption: Int = 3 // 0: 关闭, 3: 3s, 6: 6s
    @State private var isShutterSoundOff: Bool = false
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            if countdownOption == 0 {
                                countdownOption = 3
                            } else if countdownOption == 3 {
                                countdownOption = 6
                            } else {
                                countdownOption = 0
                            }
                        }) {
                            Text(countdownOption == 0 ? "关闭" : "\(countdownOption)s")
